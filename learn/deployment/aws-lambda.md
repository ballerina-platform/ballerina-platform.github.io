...
The following code presents a few examples on how to expose functions in AWS Lambda, which contains a generic `json` event input, and other functions which provides the event information using domain specific event types.
